...
import 'application/auth/signIn_form/sign_in_form_bloc.dart' as _i13;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i12.NoteWatcherBloc>(
      () => _i12.NoteWatcherBloc(get<_i5.INoteRepository>()));
  gh.factory<_i13.SignInFormBloc>(
      () => _i13.SignInFormBloc(get<_i14.IAuthFacade>()));
  gh.factory<_i15.AuthenticationBloc>(
      () => _i15.AuthenticationBloc(get<_i5.IAuthFacade>()));
  return get;
}
